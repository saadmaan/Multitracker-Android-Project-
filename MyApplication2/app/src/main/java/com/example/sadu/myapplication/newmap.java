...
public class newmap extends FragmentActivity implements OnMapReadyCallback,
    ...
    private void handleNewLocation(Location location) {
        ...
        request();
        double lati = Double.parseDouble(result);
        double longi = Double.parseDouble(result1);

        double currentLatitude = lati;


        double currentLongitude = longi;


        LatLng latLng = new LatLng(currentLatitude, currentLongitude);
        String name1= "sadu";
        System.out.println("..................>>>"+name1);
        //LocUpdate(clt,cln,name1);
    ...
    public void request(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,"http://10.100.6.30/client/other_loc.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
...

                {
                    ...
                    JSONObject job = new JSONObject(response);
                     ...
                     result = job.getString("lat");
                     result1 = job.getString("long");
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(newmap.this, error.getMessage(), Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
